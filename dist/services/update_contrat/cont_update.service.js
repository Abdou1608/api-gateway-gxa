...
async function cont_update(contrat, effet, piece, data, BasSecurityContext) {
    ...
    const result = await (0, soap_service_1.sendSoapRequest)(params, "Cont_Update", BasSecurityContext, "cont", data);
    return result;
}
