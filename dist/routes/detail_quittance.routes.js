...
router.post('/', (0, zodValidator_1.validateBody)(api_detail_quittanceValidator_1.api_detail_quittanceValidator), (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await (0, quittance_details_service_1.quittance_details)(quittance, details, garanties, addinfospqg, intervenants, addinfosqint, _BasSecurityContext, { userId: req.user?.sub, domain: req.body?.domain });
    res.json(result);
}));
