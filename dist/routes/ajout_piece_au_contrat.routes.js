...
router.post('/', (0, zodValidator_1.validateBody)(api_ajout_piece_au_contratValidator_1.api_ajout_piece_au_contratValidator), (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await (0, cont_newpiece_service_1.cont_newpiece)(contrat, produit, effet, data, _BasSecurityContext, { userId: req.user?.sub, domain: req.body?.domain });
    res.json(result);
}));
