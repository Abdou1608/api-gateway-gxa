...
router.post('/', (0, zodValidator_1.validateBody)(api_tiers_searchValidator_1.api_tiers_searchValidator), (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await (0, tiers_search_service_1.tiers_search)(_BasSecurityContext, reference, dppname, ntel, datenais, typetiers, rsociale, { userId: req.user?.sub, domain: req.body?.domain });
    res.json(result);
}));
