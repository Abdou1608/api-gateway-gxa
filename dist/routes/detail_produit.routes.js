...
router.post('/', (0, zodValidator_1.validateBody)(api_detail_produitValidator_1.api_detail_produitValidator), (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await (0, produit_details_service_1.produit_details)(code, _BasSecurityContext, options, basecouv, clauses, { userId: req.user?.sub, domain: req.body?.domain });
    res.json(result);
}));
